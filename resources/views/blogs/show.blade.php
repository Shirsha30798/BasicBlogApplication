...
<div class="container-fluid">
    <div class="jumbotron "
        style="background: linear-gradient(to right, #1D4350, #A43931); background-image: url(/image/featured_image/{{ $blog->featured_image ? $blog->featured_image:'background: linear-gradient(to right, #1D4350, #A43931)'}});background-size: cover;height: 100%;">
        <div class="col-md-12">
            <div>
